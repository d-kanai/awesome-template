 ...
 */
package com.example.demo.shared.jooq.routines;
...
public class PgpPubDecrypt2 extends AbstractRoutine<String> {
  ...
  public static final Parameter<byte[]> _2 =
      Internal.createParameter("_2", SQLDataType.BLOB, false, true);
  ...
  public PgpPubDecrypt2() {
    super("pgp_pub_decrypt", Public.PUBLIC, SQLDataType.CLOB);
