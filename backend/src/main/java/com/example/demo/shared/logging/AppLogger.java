...
public class AppLogger {
  ...
  public void logExternalApiRequest(
      final Class<?> clazz, final String apiName, final Object request) {
    final Logger logger = LoggerFactory.getLogger(clazz);
    logger.info(
  ...
  /** 外部APIレスポンス成功のログを出力. */
  public void logExternalApiResponse(final Class<?> clazz, final String apiName) {
    final Logger logger = LoggerFactory.getLogger(clazz);
    logger.info(
  ...
  public void logExternalApiException(
      final Class<?> clazz, final String apiName, final Exception ex) {
    final Logger logger = LoggerFactory.getLogger(clazz);
    logger.error(
