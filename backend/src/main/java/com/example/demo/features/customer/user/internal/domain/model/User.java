package com.example.demo.features.customer.user.internal.domain.model;

import com.example.demo.features.customer.user.internal.domain.event.UserSignedUpEvent;
import com.example.demo.features.customer.user.internal.domain.valueobject.UserEmail;
import com.example.demo.features.customer.user.internal.domain.valueobject.UserId;
import com.example.demo.features.customer.user.internal.domain.valueobject.UserPassword;
