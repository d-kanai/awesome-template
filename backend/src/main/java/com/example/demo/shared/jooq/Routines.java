...
import com.example.demo.shared.jooq.routines.Armor1;
import com.example.demo.shared.jooq.routines.Armor2;
import com.example.demo.shared.jooq.routines.Crypt;
import com.example.demo.shared.jooq.routines.Dearmor;
import com.example.demo.shared.jooq.routines.Decrypt;
import com.example.demo.shared.jooq.routines.DecryptIv;
import com.example.demo.shared.jooq.routines.Digest1;
import com.example.demo.shared.jooq.routines.Digest2;
import com.example.demo.shared.jooq.routines.Encrypt;
import com.example.demo.shared.jooq.routines.EncryptIv;
import com.example.demo.shared.jooq.routines.GenRandomBytes;
import com.example.demo.shared.jooq.routines.GenRandomUuid;
import com.example.demo.shared.jooq.routines.GenSalt1;
import com.example.demo.shared.jooq.routines.GenSalt2;
import com.example.demo.shared.jooq.routines.Hmac1;
import com.example.demo.shared.jooq.routines.Hmac2;
import com.example.demo.shared.jooq.routines.PgpKeyId;
import com.example.demo.shared.jooq.routines.PgpPubDecrypt1;
import com.example.demo.shared.jooq.routines.PgpPubDecrypt2;
import com.example.demo.shared.jooq.routines.PgpPubDecrypt3;
import com.example.demo.shared.jooq.routines.PgpPubDecryptBytea1;
import com.example.demo.shared.jooq.routines.PgpPubDecryptBytea2;
import com.example.demo.shared.jooq.routines.PgpPubDecryptBytea3;
import com.example.demo.shared.jooq.routines.PgpPubEncrypt1;
import com.example.demo.shared.jooq.routines.PgpPubEncrypt2;
import com.example.demo.shared.jooq.routines.PgpPubEncryptBytea1;
import com.example.demo.shared.jooq.routines.PgpPubEncryptBytea2;
import com.example.demo.shared.jooq.routines.PgpSymDecrypt1;
import com.example.demo.shared.jooq.routines.PgpSymDecrypt2;
import com.example.demo.shared.jooq.routines.PgpSymDecryptBytea1;
import com.example.demo.shared.jooq.routines.PgpSymDecryptBytea2;
import com.example.demo.shared.jooq.routines.PgpSymEncrypt1;
import com.example.demo.shared.jooq.routines.PgpSymEncrypt2;
import com.example.demo.shared.jooq.routines.PgpSymEncryptBytea1;
import com.example.demo.shared.jooq.routines.PgpSymEncryptBytea2;
...
public class Routines {
  ...
  public static byte[] decryptIv(
      Configuration configuration, byte[] __1, byte[] __2, byte[] __3, String __4) {
  ...
  public static Field<byte[]> decryptIv(
      Field<byte[]> __1, Field<byte[]> __2, Field<byte[]> __3, Field<String> __4) {
    DecryptIv f = new DecryptIv();
    f.set__1(__1);
    f.set__2(__2);
    f.set__3(__3);
  ...
  public static String pgpPubDecrypt2(
      Configuration configuration, byte[] __1, byte[] __2, String __3) {
  ...
  public static Field<String> pgpPubDecrypt2(
      Field<byte[]> __1, Field<byte[]> __2, Field<String> __3) {
    PgpPubDecrypt2 f = new PgpPubDecrypt2();
    f.set__1(__1);
    f.set__2(__2);
    f.set__3(__3);
  ...
  public static String pgpPubDecrypt3(
      Configuration configuration, byte[] __1, byte[] __2, String __3, String __4) {
  ...
  public static Field<String> pgpPubDecrypt3(
      Field<byte[]> __1, Field<byte[]> __2, Field<String> __3, Field<String> __4) {
    PgpPubDecrypt3 f = new PgpPubDecrypt3();
    f.set__1(__1);
    f.set__2(__2);
    f.set__3(__3);
  ...
  public static byte[] pgpPubEncrypt2(
      Configuration configuration, String __1, byte[] __2, String __3) {
  ...
  public static Field<byte[]> pgpPubEncrypt2(
      Field<String> __1, Field<byte[]> __2, Field<String> __3) {
    PgpPubEncrypt2 f = new PgpPubEncrypt2();
    f.set__1(__1);
    f.set__2(__2);
    f.set__3(__3);
  ...
  public static String pgpSymDecrypt2(
      Configuration configuration, byte[] __1, String __2, String __3) {
  ...
  public static Field<String> pgpSymDecrypt2(
      Field<byte[]> __1, Field<String> __2, Field<String> __3) {
    PgpSymDecrypt2 f = new PgpSymDecrypt2();
    f.set__1(__1);
    f.set__2(__2);
    f.set__3(__3);
  ...
  public static Result<PgpArmorHeadersRecord> pgpArmorHeaders(
    ...
    return configuration
        .dsl()
        .selectFrom(com.example.demo.shared.jooq.tables.PgpArmorHeaders.PGP_ARMOR_HEADERS.call(__1))
        .fetch();
  }

  /** Get <code>public.pgp_armor_headers</code> as a table. */
  public static PgpArmorHeaders pgpArmorHeaders(String __1) {
    return com.example.demo.shared.jooq.tables.PgpArmorHeaders.PGP_ARMOR_HEADERS.call(__1);
  }
