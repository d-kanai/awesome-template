...
import com.example.demo.features.authcustomer.internal.application.command.CustomerSignupCommand;
...
public class CustomerSignupRestApi {

  public static final String ENDPOINT = "/signup";

  private final CustomerSignupCommand customerSignupCommand;

  public CustomerSignupRestApi(final CustomerSignupCommand customerSignupCommand) {
    this.customerSignupCommand = customerSignupCommand;
  }
  ...
  public ResponseEntity<Output> execute(@Valid @RequestBody final Input input) {
    final CustomerSignupCommand.Output result =
        customerSignupCommand.execute(
            new CustomerSignupCommand.Input(input.email(), input.password()));
  ...
  public record Output(
    ...
    public static Output from(final CustomerSignupCommand.Output result) {
