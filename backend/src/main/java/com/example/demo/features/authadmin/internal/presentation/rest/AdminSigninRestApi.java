...
import com.example.demo.features.authadmin.internal.application.command.AdminSigninCommand;
...
public class AdminSigninRestApi {

  public static final String ENDPOINT = "/signin";

  private static final String ADMIN_COOKIE_NAME = "adminAccessToken";

  private final AdminSigninCommand adminSigninCommand;
  private final AppProperties appProperties;

  public AdminSigninRestApi(
      final AdminSigninCommand adminSigninCommand, final AppProperties appProperties) {
    this.adminSigninCommand = adminSigninCommand;
  ...
  public ResponseEntity<Output> execute(
    ...
    final AdminSigninCommand.Output result =
        adminSigninCommand.execute(new AdminSigninCommand.Input(input.email(), input.password()));
