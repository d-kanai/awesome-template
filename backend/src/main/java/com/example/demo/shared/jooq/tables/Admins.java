...
public class Admins extends TableImpl<AdminsRecord> {
     ...
     */
    public final TableField<AdminsRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<AdminsRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.admins.updated_at</code>.
     */
    public final TableField<AdminsRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_ADMINS_EMAIL);
    }
    ...
    public List<UniqueKey<AdminsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.ADMINS_EMAIL_KEY);
    }
