...
import static com.example.demo.features.authcustomer.internal.presentation.rest.CustomerAuthApiPath.BASE;

import com.example.demo.features.authcustomer.internal.application.command.CustomerSigninCommand;
...
public class CustomerSigninRestApi {

  public static final String ENDPOINT = "/signin";

  private final CustomerSigninCommand customerSigninCommand;
  private final AppProperties appProperties;

  public CustomerSigninRestApi(
      final CustomerSigninCommand customerSigninCommand, final AppProperties appProperties) {
    this.customerSigninCommand = customerSigninCommand;
  ...
  public ResponseEntity<Output> execute(
    ...
    final CustomerSigninCommand.Output result =
        customerSigninCommand.execute(
            new CustomerSigninCommand.Input(input.email(), input.password()));
  ...
  public record Output(
    ...
    public static Output from(final CustomerSigninCommand.Output result) {
