...
public class User {
    ...
    private User(Long id, UserEmail email, String name, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.email = email;
        this.name = name;
    ...
    public static User signup(String email, String name) {
        return new User(null, UserEmail.of(email), name, null, null);
    }

    public static User reconstruct(Long id, String email, String name, LocalDateTime createdAt, LocalDateTime updatedAt) {
