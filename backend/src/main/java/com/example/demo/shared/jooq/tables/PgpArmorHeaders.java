...
public class PgpArmorHeaders extends TableImpl<PgpArmorHeadersRecord> {
  ...
  public final TableField<PgpArmorHeadersRecord, String> KEY =
      createField(DSL.name("key"), SQLDataType.CLOB, this, "");

  /** The column <code>public.pgp_armor_headers.value</code>. */
  public final TableField<PgpArmorHeadersRecord, String> VALUE =
  ...
  private PgpArmorHeaders(
      Name alias, Table<PgpArmorHeadersRecord> aliased, Field<?>[] parameters, Condition where) {
  ...
  public PgpArmorHeaders call(String __1) {
    PgpArmorHeaders result =
        new PgpArmorHeaders(
            DSL.name("pgp_armor_headers"), null, new Field[] {DSL.val(__1, SQLDataType.CLOB)});
  ...
  public PgpArmorHeaders call(Field<String> __1) {
    PgpArmorHeaders result =
        new PgpArmorHeaders(DSL.name("pgp_armor_headers"), null, new Field[] {__1});
