...
public class UserController {
  ...
  @Operation(summary = "ID でユーザーを取得", description = "指定した識別子のユーザーを取得します。")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(summary = "メールアドレスでユーザーを取得", description = "指定したメールアドレスのユーザーを取得します。")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "ユーザーが見つかりました。",
  ...
  public ResponseEntity<FindUserByEmailOutput> getUserByEmail(
      @Parameter(description = "ユーザーのメールアドレス", example = "jane.doe@example.com") @PathVariable
          final String email) {
  ...
  @Operation(summary = "ユーザーを削除", description = "指定した識別子のユーザーを削除します。")
  @ApiResponses({
