...
public class PgpSymDecryptBytea2 extends AbstractRoutine<byte[]> {
  ...
  /** The parameter <code>public.pgp_sym_decrypt_bytea._3</code>. */
  public static final Parameter<String> _3 =
      Internal.createParameter("_3", SQLDataType.CLOB, false, true);

  /** Create a new routine call instance */
  public PgpSymDecryptBytea2() {
    super("pgp_sym_decrypt_bytea", Public.PUBLIC, SQLDataType.BLOB);
