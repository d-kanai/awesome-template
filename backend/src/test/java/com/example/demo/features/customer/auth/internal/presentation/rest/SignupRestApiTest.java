...
import com.example.demo.features.customer.user.internal.domain.event.UserEventEnum;
...
import com.example.demo.features.customer.auth.testsupport.TestExternalApi;
...
class SignupRestApiTest {
  ...
  void ユーザーを作成しCreatedレスポンスを返す() throws Exception {
    ...
    // when
    final ApiTestResponse response = apiTestClient.post("/customer/auth/signup", request);
